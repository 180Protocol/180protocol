...
class EnclaveClientService(val services: ServiceHub) : SingletonSerializeAsToken() {
    ...
    fun createAvroDataFileFromGenericRecords(schema: Schema?, genericRecords: ArrayList<GenericRecord>, filename: String?): File {
    ...
    fun createGenericSchemaRecords(schema: Schema?): ArrayList<GenericRecord> {
    ...
    fun generateRandomDemandRecord(schema: Schema?): GenericRecord {
