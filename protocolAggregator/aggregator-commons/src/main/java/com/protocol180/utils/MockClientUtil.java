...
public class MockClientUtil {
    ...
    public static Schema envelopeSchema;
    public static Schema aggregationInputSchema;
    public static Schema aggregationOutputSchema;
    public static Schema provenanceOutputSchema;
    public static Schema identitySchema;
    ...
    public byte[] createProviderDataRecordForAggregation() throws IOException {
    ...
    public static ArrayList<GenericRecord> readGenericRecordsFromOutputBytesAndSchema(byte[] outputBytes, String schemaType) throws IOException {
...
//        File dataFile = new File("dataFile");
        SeekableInput input = new SeekableByteArrayInput(outputBytes);
