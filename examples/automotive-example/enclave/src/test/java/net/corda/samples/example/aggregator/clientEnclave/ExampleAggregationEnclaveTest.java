...
public class ExampleAggregationEnclaveTest {
    ...
    void aggregateDataOutputTest() throws IOException, EnclaveLoadException, AggregationEnclave.UnsupportedDataTypeException, MailDecryptionException {
        ...
        System.out.println(ClassLoader.getSystemClassLoader().getResource("automotive.avsc"));

        File automotiveSchemaFile = new File(ClassLoader.getSystemClassLoader().getResource("automotive.avsc").getPath());
        File automotiveDataFile = new File(ClassLoader.getSystemClassLoader().getResource("AutomotiveMarketResearchSampleData.csv").getPath());
        /*
