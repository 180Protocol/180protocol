...
export const API_URL = 'http://localhost:9400/node';

export const ENCRYPTED_DATA_OUTPUT_RESPONSE = {
...
export const DECRYPTED_DATA_OUTPUT_RESPONSE = {
...
export const ENCRYPTED_REWARDS_DATA_RESPONSE = {
    "stateTypes": "UNCONSUMED",
    "states": [{
        "ref": {
            "index": 0,
...
export const DECRYPTED_REWARDS_DATA_RESPONSE = {
